...
const MathQuestion: React.FC<MathQuestionProps> = ({ level }) => {
  ...
  const fetchQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://squlio.edu.pl/api/math-questions/${level}`, {
  ...
  const submitAnswer = async (answer: string, event: React.MouseEvent) => {
    ...
    try {
      ...
      const response = await fetch('https://squlio.edu.pl/api/submit-math-answer', {
        method: 'POST',
        headers: {
      ...
      {userStats && (
        <div className="user-stats">
          ...
          <div className="question-character-extracoins-box">
            ...
            <div className="question-character-extracoins">{userStats.extracoins}</div>
          </div>
